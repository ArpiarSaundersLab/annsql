...
comparisons =  pd.read_csv(f'../results/comparisons_memory_splatter_Python.csv')
comparisons = pd.concat([comparisons, pd.read_csv(f'../results/comparisons_memory_splatter_R.csv')]).reset_index(drop=True)
comparisons

#set the colors of the plots (ansql1, anndata in-mem, ansql2, anndata backed)
colors = ["#07b88e", "#a4a6a4", "#07b88e", "#a4a6a4","#FFA067"]

#replace inf values with log(0.01)
