...
plt.ylabel("Seconds", fontsize=18, fontweight='bold')
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 1", fontsize=22, fontweight='bold')
plt.show()
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 2", fontsize=22, fontweight='bold')
plt.show()
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 3", fontsize=22, fontweight='bold')
plt.show()
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 4", fontsize=22, fontweight='bold')
plt.show()
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 5", fontsize=22, fontweight='bold')
plt.show()
...
plt.gca().spines['bottom'].set_linewidth(3)
plt.gca().spines['bottom'].set_color('black')
plt.title("Filter vs Query 6", fontsize=22, fontweight='bold')
plt.show()
